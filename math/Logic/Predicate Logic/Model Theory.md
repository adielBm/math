...
- (6.10) **Löwenheim–Skolem theorem** - if a [[Logic/Predicate Logic/Semantic#Theory|theory]] $K$ [[Logic/Predicate Logic/Semantic#Model of Set|has an infinite model]], then it has also countable model
